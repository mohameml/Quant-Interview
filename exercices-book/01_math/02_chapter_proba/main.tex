...
% Depuis le sommet de départ (Type 0) :
% \begin{itemize}
%     \item 3 arêtes mènent vers des sommets de Type 1
%     \item Probabilité : $\mathbb{P}(0 \to 1) = 1$
% \end{itemize}

% Depuis un sommet de Type 1 :
% \begin{itemize}
%     \item 1 arête retourne au sommet de départ (Type 0)
%     \item 2 arêtes mènent vers des sommets de Type 2
%     \item Probabilités : $\mathbb{P}(1 \to 0) = \frac{1}{3}$, $\mathbb{P}(1 \to 2) = \frac{2}{3}$
% \end{itemize}

% Depuis un sommet de Type 2 :
% \begin{itemize}
%     \item 2 arêtes retournent vers des sommets de Type 1
%     \item 1 arête mène au sommet cible (Type 3)
%     \item Probabilités : $\mathbb{P}(2 \to 1) = \frac{2}{3}$, $\mathbb{P}(2 \to 3) = \frac{1}{3}$
% \end{itemize}
